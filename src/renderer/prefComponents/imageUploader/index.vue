    ...
    <section class="configration">
      <el-tabs v-model="activeTab">
        ...
        <el-tab-pane label="Gitee" name="gitee">
          ...
          <div class="form-group">
            <div class="label">Owner name:</div>
            <el-input v-model="gitee.giteeOwner" placeholder="owner" size="mini"></el-input>
          </div>
          <div class="form-group">
            <div class="label">Repo name:</div>
            <el-input v-model="gitee.giteeRepo" placeholder="repo" size="mini"></el-input>
          </div>
          <div class="form-group">
            <div class="label">Branch name (optional):</div>
            <el-input v-model="gitee.giteeBranch" placeholder="branch" size="mini"></el-input>
          </div>
          <legal-notices-checkbox
            class="gitee"
...
export default {
  ...
  computed: {
    ...
    giteeDisable () {
      return !this.giteeToken || !this.gitee.giteeOwner || !this.gitee.giteeRepo
    }
  },
  watch: {
